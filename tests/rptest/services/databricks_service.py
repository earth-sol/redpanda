...
class DatabricksService:
    """
    A service module for managing Databricks Catalog objects.
    
    This class provides functions to manage external locations, catalogs, tables,
    and to run SQL queries against the data.
    ...
    def __init__(self, catalog_name: str, storage_root: str):
        """
        Initialize a new instance of DatabricksService.
